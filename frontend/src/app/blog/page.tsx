...
export const metadata: Metadata = {
  title: "ArioClip Blog | AI Video Clipping Guides",
  description:
    "SEO guides, product comparisons, and creator workflows for turning long-form video into social-ready shorts with ArioClip.",
  alternates: {
