...
export const HOSTED_APP_URL = "https://arioclip.app";
...
export const blogPosts: BlogPost[] = [
  {
    ...
    description:
      "Looking for a free OpusClip alternative? ArioClip is an open-source AI clip maker that turns long videos into captioned, vertical shorts you can self-host.",
    ...
    summary:
      "ArioClip is built for creators who want OpusClip-style AI clipping without committing to another credit-based subscription.",
  },
];
...
export function getBlogPostMetadata(post: BlogPost): Metadata {
  ...
  return {
    title: `${post.title} | ArioClip Blog`,
