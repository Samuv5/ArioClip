...
const HOSTED_APP_URL = "https://arioclip.app";
  ...
  return [
    {
      ...
      cta: "View on GitHub",
      ctaHref: "https://github.com/Samuv5/ArioClip",
      highlighted: false,
    },
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            <div>
              ...
              >
                ...
                <a
                  href="https://github.com/Samuv5/ArioClip"
                  target="_blank"
                ...
                <div className="bg-primary text-primary-foreground rounded-lg p-5 font-mono text-sm leading-loose overflow-x-auto">
                  <div>
                    ...
                    <span className="opacity-40">
                      https://github.com/Samuv5/ArioClip
                    </span>
                  </div>
                  <div>
                    <span className="opacity-50">$</span>{" "}
                    cd{" "}
                    <span className="opacity-40">arioclip</span>
                  </div>
                  <div>
                    <span className="opacity-50">$</span>{" "}
                    docker-compose up -d
